    ...
    <Container>
      <div className={cn(s.root, "fit", "mb-5")}>
        ...
        <div className={s.sidebar}>
          <section>
            <div className="text-2xl font-bold leading-7 text-black sm:truncate sm:text-3xl sm:tracking-tight">
              <h1>{product.name}</h1>
            </div>         
            <div className="py-5 pb-4 text-primary font-bold tracking-wide">          
